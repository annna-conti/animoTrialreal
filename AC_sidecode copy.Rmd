...
```{r}
#trying to make a wide table to be able to look at the area progression for each individual across time, to make sure the segmentations i made make sense 
